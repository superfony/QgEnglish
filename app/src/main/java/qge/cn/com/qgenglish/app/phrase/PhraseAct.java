 ...
 * 单词选关界面    识记  复习  检查  统计
 */
public class PhraseAct extends BaseActivity {
...
//    LinearLayout info_container;
    ...
    private void initData() {
        ...
        if (isHave) {
            ...
            long wordSize = DBManager.getInstance().getWordCount(tableName);
            int copintSize = (int) (wordSize / 14) + 1;
        ...
        word_cp_lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(activity, SjPhraseAct.class);  //  单词识记的
