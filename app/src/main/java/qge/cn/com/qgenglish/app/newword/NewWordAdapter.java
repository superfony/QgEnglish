...
public class NewWordAdapter extends BaseAdapter {
    private List<NewWordbeanS> wordBeanOldLists = null;
    private Context mContext;
    public int chooseNum = 0;

    public void setChooseWordListion(NewWordChoseAct.ChooseWordListion chooseWordListion) {
        this.chooseWordListion = chooseWordListion;
    }

    private NewWordChoseAct.ChooseWordListion chooseWordListion;

    public NewWordAdapter(Context mContext, List<NewWordbeanS> wordBeanOldLists) {
        this.mContext = mContext;
        this.wordBeanOldLists = wordBeanOldLists;
    }

    public void updateListView(List<NewWordbeanS> wordBeanOldLists) {
        this.wordBeanOldLists = wordBeanOldLists;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final NewWordbeanS wordBeanOlds = wordBeanOldLists.get(position);
        if (view == null) {
