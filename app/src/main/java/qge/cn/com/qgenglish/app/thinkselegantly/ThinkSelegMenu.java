...
public class ThinkSelegMenu extends BaseActivity {
    private String TAG = "FourLevelMenu";
    @Bind(R.id.title)
    TextView title;
    @Bind(R.id.ckxz_lv)
    ListView ckxzLv;
    private ThinkSelegMenuAdapter wordMenuThAdapter;

    private String[] menuArr = {"雅思词汇", "我的生词本"};
    ...
    private void initData() {
        title.setText("雅思课程");
        wordMenuThAdapter = new ThinkSelegMenuAdapter(activity, menuArrayList);
        ...
        ckxzLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    intent.setClass(activity, ThinkSelegWordMenu.class);
                } else if (position == 1) {
