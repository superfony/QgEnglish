...
public class ExpWordAdapter extends BaseAdapter {
    private List<WordBeanOlds> wordBeanOldLists = null;
    private Context mContext;
    public int chooseNum = 0;

    public void setChooseWordListion(ExpChoseWordAct.ChooseWordListion chooseWordListion) {
        this.chooseWordListion = chooseWordListion;
    }

    private ExpChoseWordAct.ChooseWordListion chooseWordListion;

    public ExpWordAdapter(Context mContext, List<WordBeanOlds> wordBeanOldLists) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.exp_adapter, null);
