...
import qge.cn.com.qgenglish.app.word.review.FxPaginationWidget;
 ...
 * 复习 跳转识记的地方
 */
public class NewSjWordAct extends BaseActivity {
    @Bind(R.id.sj_lv)
    ListView sjLv;
    @Bind(R.id.sj_root)
    ...
    private NewSjwordAdapter sjwordAdapter;
    private List<Word_unskilled> wordBeanOldList = new ArrayList<Word_unskilled>();
    private List<Word_unskilled> fxWordList = new ArrayList<Word_unskilled>();
    private int count;
    ...
    private void initData() {
        ...
        wordBeanOldList = (ArrayList<Word_unskilled>) intent.getSerializableExtra("sjArray");  // 接收传递的单词的总的
    ...
    private void initPaginationWidget(int count) {
        ...
        paginationWidget.setPageSize(NewSjWordAct.pageSize);
    ...
    private void initAdpater() {
        ...
        sjwordAdapter = new NewSjwordAdapter(activity, fxWordList);
        ...
        sjLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Word_unskilled wordBeanOld = fxWordList.get(position);
...
//                icibaHttp(word, wordHandler);// 读取发音
        ...
        sjLv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                final Word_unskilled wordBeanOld = fxWordList.get(position);
...
//                        setPositiveButton("生词", new DialogInterface.OnClickListener() {
//                    @Override
