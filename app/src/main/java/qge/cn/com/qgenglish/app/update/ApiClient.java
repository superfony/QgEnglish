package qge.cn.com.qgenglish.app.update;
...
import qge.cn.com.qgenglish.application.AppException;
...
public class ApiClient {
    ...
    public static Update checkVersion(AppContext appContext) throws AppException {
        try {
            return Update.parse(http_get(appContext, RequestUrls.UPDATE_VERSION));
        } catch (Exception e) {
