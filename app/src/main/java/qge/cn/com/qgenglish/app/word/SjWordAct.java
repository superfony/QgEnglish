...
public class SjWordAct extends BaseActivity {
    ...
    private void initData() {
        ...
        if (wordBeanOldList != null) {
            ...
            long countlong = DBManager.getWordManager().getCount(Word_niujinban_7_1.class);
            count = (int) countlong;
            wordBeanOldList = DBManager.getWordManager().get(Word_niujinban_7_1.class, 0, SjWordAct.pageSize);
        }
    }
