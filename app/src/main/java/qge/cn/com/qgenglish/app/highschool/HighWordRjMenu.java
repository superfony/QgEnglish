    ...
    private void initData() {
        ...
        ckxzLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        ((FonyApplication) activity.getApplication()).tableDes = "人教版高中1";
                        intent.putExtra("tableName", TableName.word_renjiao_compulsory_1);
                        break;
                    case 1:
                        ((FonyApplication) activity.getApplication()).tableDes = "人教版高中2";
                        intent.putExtra("tableName", TableName.word_renjiao_compulsory_2);
                        break;
                    case 2:
                        ((FonyApplication) activity.getApplication()).tableDes = "人教版高中3";
                        intent.putExtra("tableName", TableName.word_renjiao_compulsory_3);
                        break;
                    case 3:
                        ((FonyApplication) activity.getApplication()).tableDes = "人教版高中4";
                        intent.putExtra("tableName", TableName.word_renjiao_compulsory_4);
                        break;
                    case 4:
                        ((FonyApplication) activity.getApplication()).tableDes = "人教版高中5";
                        intent.putExtra("tableName", TableName.word_renjiao_compulsory_5);
                        break;
                    case 5:
                        ((FonyApplication) activity.getApplication()).tableDes = "人教版高中6";
                        intent.putExtra("tableName", TableName.word_renjiao_compulsory_6);
                        break;
                    case 6:
                        ((FonyApplication) activity.getApplication()).tableDes = "人教版高中7";
                        intent.putExtra("tableName", TableName.word_renjiao_compulsory_7);
                        break;
                    case 7:
                        ((FonyApplication) activity.getApplication()).tableDes = "人教版高中8";
